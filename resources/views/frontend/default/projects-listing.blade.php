                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="category-filter fs-14">
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            @foreach (\App\Models\ProjectCategory::where('parent_id', 0)->get() as
                                            $category)
                                            <li><span style="
                                                            background: #d65e2c;
                                                            padding: 1%;
                                                        ...
                                                        " class="label label-warning">11</span><a
                                            ...
                                            @foreach
                                            (\App\Utility\CategoryUtility::get_immediate_children_ids($category_id) as
                                            $key => $id)
                                            <li><a
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="aiz-checkbox-list">
                                        <label class="aiz-checkbox">
                                            <input type="checkbox" name="projectType[]" value="Fixed" @if
                                                (in_array('Fixed', $projectType)) checked @endif
                                                onchange="applyFilter()"> {{ translate('Fixed Price') }}
                                            <span class="aiz-square-check"></span>
                                            <span
                                                class="float-right text-secondary fs-12">({{ DB::table('projects')->where('type',"Fixed")->count() }})</span>
                                        </label>
                                        <label class="aiz-checkbox">
                                            <input type="checkbox" name="projectType[]" value="Long Term" @if
                                                (in_array('Long Term', $projectType)) checked @endif
                                                onchange="applyFilter()"> {{ translate('Long Term') }}
                                            <span class="aiz-square-check"></span>
                                            <span
                                                class="float-right text-secondary fs-12">({{ DB::table('projects')->where('type',"long_term")->count() }})</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="mb-5">
                                    ...
                                    <div class="aiz-radio-list">
                                        <label class="aiz-radio">
                                            <input type="radio" name="bids" value="" onchange="applyFilter()" @if
                                                ($bids=="" ) checked @endif> {{ translate('Any Number of bids') }}
                                            <span class="aiz-rounded-check"></span>
                                            <span
                                                class="float-right text-secondary fs-12">({{ DB::table('projects')->where('bids',0)->count() }})</span>
                                        </label>
                                        <label class="aiz-radio">
                                            <input type="radio" name="bids" value="0-5" onchange="applyFilter()" @if
                                                ($bids=="0-5" ) checked @endif> {{ translate('0 to 5') }}
                                            <span class="aiz-rounded-check"></span>
                                            <span
                                                class="float-right text-secondary fs-12">({{ DB::table('projects')->whereBetween('bids', [0, 5])->count() }})</span>
                                        </label>
                                        <label class="aiz-radio">
                                            <input type="radio" name="bids" value="5-10" onchange="applyFilter()" @if
                                                ($bids=="5-10" ) checked @endif> {{ translate('5 to 10') }}
                                            <span class="aiz-rounded-check"></span>
                                            <span
                                                class="float-right text-secondary fs-12">({{ DB::table('projects')->whereBetween('bids', [5, 10])->count() }})</span>
                                        </label>
                                        <label class="aiz-radio">
                                            <input type="radio" name="bids" value="10-20" onchange="applyFilter()" @if
                                                ($bids=="10-20" ) checked @endif> {{ translate('10 to 20') }}
                                            <span class="aiz-rounded-check"></span>
                                            <span
                                                class="float-right text-secondary fs-12">({{ DB::table('projects')->whereBetween('bids', [10, 20])->count() }})</span>
                                        </label>
                                        <label class="aiz-radio">
                                            <input type="radio" name="bids" value="20-30" onchange="applyFilter()" @if
                                                ($bids=="20-30" ) checked @endif> {{ translate('20 to 30') }}
                                            <span class="aiz-rounded-check"></span>
                                            <span
                                                class="float-right text-secondary fs-12">({{ DB::table('projects')->whereBetween('bids', [20, 30])->count() }})</span>
                                        </label>
                                        <label class="aiz-radio">
                                            <input type="radio" name="bids" value="30+" onchange="applyFilter()" @if
                                                ($bids=="30+" ) checked @endif> {{ translate('30+') }}
                                            <span class="aiz-rounded-check"></span>
                                            <span
                                                class="float-right text-secondary fs-12">({{ DB::table('projects')->whereBetween('bids', [30, 3000])->count() }})</span>
                                        </label>
                                    </div>
                                </div>
                                {{-- <div class="">
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="card mb-lg-0">
                        ...
                        <div class="card-header">
                            ...
                            <div class="w-200px">
                                <select class="form-control form-control-sm aiz-selectpicker" name="sort"
                                    onchange="applyFilter()">
                                    <option value="1" @if($sort=='1' ) selected @endif>{{ translate('Newest first') }}
                                    </option>
                            ...
                            <a href="{{ route('project.details', $project->slug) }}"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="text-muted lh-1-8">
                                        <p>{{ function_that_shortens_text_but_doesnt_cutoff_words($project->excerpt,600) }}
                                        </p>
                                    </div>
                                    <ul class="list-inline opacity-70 fs-12">
                                        ...
                                        <li class="list-inline-item">
                                            ...
                                            <span>@if ($project->project_category != null)
                                                {{ $project->project_category->name }} @else
                                ...
                                <div
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="pl-2">
                                                <h4 class="fs-14 mb-1">@if ( $project->client != null )
