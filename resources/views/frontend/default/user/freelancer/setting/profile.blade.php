            ...
            <div class="aiz-user-panel">
                        ...
                        <form class="js-validate" action="{{ route('user_profile.bio_update') }}" method="POST"
                            ...
                            <div class="js-form-message">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="username" name="username" @if
                                        ($user_profile->user->user_name != null)
                                    value="{{ $user_profile->user->user_name }}" @endif placeholder="Enter your
                                    username" aria-label="Enter your username" required aria-describedby="usernameLabel"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control" name="email" @if
                                        ($user_profile->user->email != null) value="{{ $user_profile->user->email }}"
                                    @endif placeholder="Enter your email address" aria-label="Enter your email address"
                                    required aria-describedby="emailLabel" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control aiz-selectpicker" multiple name="skills[]"
                                    ...
                                    <option value="{{ $skill->id }}" @if(in_array($skill->id,
                                        json_decode($user_profile->skills))) selected @endif>{{ $skill->name }}</option>
                                    @endforeach
                                    @else
                                    @foreach (\App\Models\Skill::all() as $key => $skill)
                        ...
                        <form class="js-validate" action="{{ route('user_profile.basic_info_update') }}" method="POST"
                            ...
                            <div class="js-form-message">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name"
                                        value="{{ $user_profile->user->name }}" placeholder="Enter your name"
                                        aria-label="Enter your name" required aria-describedby="nameLabel"
                            ...
                            <div class="js-form-message">
                                <div class="form-group">
                                    ...
                                    <select class="form-control aiz-selectpicker" id="specialist" name="specialist"
                                        ...
                                        <option value="{{ $category->id }}" @if ($user_profile->specialist ==
                                            $category->id)
                                            selected
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control aiz-selectpicker" name="gender" required
                                    ...
                                    <option value="male" @if ($user_profile->gender == 'male') selected @endif>Male
                                    </option>
                                    <option value="female" @if ($user_profile->gender == 'female') selected
                                        @endif>Female</option>
                                    <option value="other" @if ($user_profile->gender == 'other') selected @endif>Other
                                    </option>
                                </select>
                                <!-- End Input -->
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    ...
                                    <select class="form-control aiz-selectpicker" id="country_id" name="country_id"
                                        ...
                                        <option value="{{ $country->id }}" @if ($user_profile->user->address->country_id
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" id="postal_code" name="postal_code" @if
                                        ($user_profile->user->address->postal_code != null)
                                    value="{{ $user_profile->user->address->postal_code }}" @endif required
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address" @if
                                    ($user_profile->user->address->street != null)
                                value="{{ $user_profile->user->address->street }}" @endif placeholder="Enter your street
                                address" required aria-describedby="nameLabel">
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label id="nameLabel" class="form-label">
                                    ...
                                    <input type="text" class="form-control" name="phone" @if
                                        ($user_profile->user->address->phone != null)
                                    value="{{ $user_profile->user->address->phone }}" @endif placeholder="Enter your
                                    contact number" aria-label="Enter your contact number" required
                                    aria-describedby="nameLabel" data-msg="Enter your contact number."
                                    data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                                <div class="col-md-6">
                                    <label id="nameLabel" class="form-label">
                                    ...
                                    <select class="form-control aiz-selectpicker country-flag-select" id="nationality"
                                        ...
                                        @foreach (\File::files(base_path('public/assets/frontend/default/img/flags')) as
                                        $path)
                                        <option value="{{ pathinfo($path)['filename'] }}"
                                            ...
                                            @if ($user_profile->nationality == pathinfo($path)['filename']) selected
                                            @endif
                                            ></option>
                                        @endforeach
                                    </select>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row gutters-10">
                                ...
                                <div class="col-xxl-3 col-lg-4 col-sm-6">
                                    <div class="card mb-3 position-relative text-reset">
                                        <img class="img-fit mw-100" src="{{ custom_asset($portfolio->photo) }}"
                                            height="240">
                        ...
                        @endif
                        @if ($user_profile->user->userPackage->portfolio_add_limit >
                        count($user_profile->user->userPortfolios))
                        <form action="{{ route('user_profile.portfolio_add') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-2 text-right">
                                    <!-- Buttons -->
                                    <button type="submit"
                                        class="btn btn-primary ">{{ translate('Add Portfolio') }}</button>
                                    <!-- End Buttons -->
                                </div>
                            </div>
                        </form>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        @if ($user_profile->user->userPackage->job_exp_limit >
                        count($user_profile->user->workExperiences))
                        <form action="{{ route('user_profile.work_experience_add') }}" method="POST"
                            ...
                            <div class="mt-2 text-right">
                                <!-- Buttons -->
                                <button type="submit"
                                    class="btn btn-primary ">{{ translate('Add Work Experience') }}</button>
                                <!-- End Buttons -->
                            </div>
                        </form>
                        @else
                        ...
                        <form action="{{ route('user_profile.education_info_add') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div id="datepickerWrapperFrom" class="js-focus-state u-datepicker input-group">
                                    <input type="number" class="form-control" name="passing_year" placeholder="Ex. 2008"
                                        required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="mt-2 text-right">
                                <!-- Buttons -->
                                <button type="submit"
                                    class="btn btn-primary ">{{ translate('Add Education Information') }}</button>
                                <!-- End Buttons -->
                            </div>
                        </form>
                    </div>
